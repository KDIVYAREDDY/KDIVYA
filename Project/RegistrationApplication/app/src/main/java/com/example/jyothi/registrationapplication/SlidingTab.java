...
public class SlidingTab extends LinearLayout {
    ...
    protected SlidingTableLayout.TabColorizer mCustomTabColorizer;
    ...
    void setCustomTabColorizer(SlidingTableLayout.TabColorizer customTabColorizer) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final SlidingTableLayout.TabColorizer tabColorizer =mCustomTabColorizer!=null?mCustomTabColorizer:mDefaultTabColorizer;
    ...
    private static class SimpleTabColorizer implements
            SlidingTableLayout.TabColorizer {
